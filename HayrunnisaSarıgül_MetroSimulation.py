...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        while kuyruk:
            ...
            if istasyon == hedef: #gidilecek istasyon ve hedef aynı ise rota döndürülür
                 return rota

            for komsu, _ in istasyon.komsular:
                if komsu not in ziyaret_edildi: #ziyaret edilip edilmediğinin kontrolü yapılıyor
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        pq = [(0, id(baslangic), baslangic, [baslangic], 0)] #öncelik kuyruğu oluşturuldu

        while pq:
            toplam_sure, _, istasyon, rota, mevcut_sure = heapq.heappop(pq)

            if istasyon == hedef: #gidilecek istasyon ve hedef aynı ise rota ve süre döndürülür
            ...
            for komsu, sure in istasyon.komsular:
                if komsu not in ziyaret_edildi: #ziyaret edilip edilmediğinin kontrolü yapılıyor
                    heapq.heappush(pq, (toplam_sure + sure, id(komsu), komsu, rota + [komsu], sure))
        return None
